...
STATICFILES_DIRS = [
    ('hr-tech-dashboard', BASE_DIR / 'hr-tech-dashboard'),
]
...
BOT_TRANSPORT = os.getenv('BOT_TRANSPORT', 'terminal').lower()
...
WHATSAPP = {
    ...
    'WEBHOOK_CALLBACK_URL': os.getenv('WHATSAPP_WEBHOOK_CALLBACK_URL', ''),
